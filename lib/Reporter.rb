...
class Reporter
  attr_accessor :gerrit_params, :jenkins_user, :jenkins_pass, :jenkins_url
...
$LOAD_PATH.unshift(lib) unless $LOAD_PATH.include?(lib)
  ...
  def GerritProjects
    ...
    gerrit_lexicon.gerrit_url   = @gerrit_params[0]
    gerrit_lexicon.gerrit_user  = @gerrit_params[1]
    gerrit_lexicon.gerrit_pass  = @gerrit_params[2]
